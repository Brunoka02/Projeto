        ...
        if desejo_de_personagem == "SIM":
            ...
            if acao_porta == 2:
                ...
                if resposta.upper() == "MORTE":
                    print("Você escolhe, entre os diver sos simbolos na fachadura o que mais \nte remete a morte, e ela se abre, o caminho esta livre")
                else:
            ...
            while as_4_salas == True:
                ...
                if sala_escolhida == 1:
                    if conhecimeto_colecao == 0:
                        ...
                        if acao_colecao == 3:
                            print("Você da um tiro certeiro no seurança, deixando o caminho livre")
                            balas = balas - 1
...
Ela atiça sua curiosidade, mas esqueceu sua bolsa, deseja
...
O que você faz?''')
            ...
            while True:
                acao_porta_tocha = input()
                if acao_porta_tocha != "APAGO A TOCHA" or acao_porta_tocha !="APAGAR A tocha":
                    break
                else:
                    print("Nada acontece")
...
tornou nisso. O que vive aqui não deve sair' ''')
                ...
                if sair_ou_nao == "SAIR":
                    print("Você aceita o conselho daquele ser, e foge em disparada daquele lugar")
...
eu tenha sujar mais minhas mãos' ''')
                ...
                print('''Você ataca a fera com sua adaga e, mesmo no escuro, você acerta o coração dela.
